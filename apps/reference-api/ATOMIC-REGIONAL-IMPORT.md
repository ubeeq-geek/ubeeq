...
the same migration to resume through cutover. Separate paths cover rollback and
retirement; new migrations after rollback now require destination reconciliation
as described in REGIONAL-IMPORT-CONFLICTS.md.
...
future work. Existing IDs now require exact replay equivalence; destination conflict reconciliation,
