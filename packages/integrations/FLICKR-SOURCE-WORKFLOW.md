...
still scans the whole item list and saves one final migration checkpoint; content
side effects and checkpoint writes are separate. Applications need idempotent
attachment implementations and durable storage. Bounded continuation, checkpoint
concurrency and orphan quarantine recovery remain unfinished. A scan verdict is
