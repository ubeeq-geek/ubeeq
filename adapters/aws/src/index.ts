...
import { createTransactionalDynamo } from './transactions.js';
...
type Dynamo = Pick<DynamoDBDocumentClient, "send"> & { assertTransaction?: (transaction: { id: string }) => void };
